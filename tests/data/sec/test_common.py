...
from stockdownloader.data.sec.common import (
    ARCHIVE_BASE,
    EFTS_BASE_URL,
...
class TestDownloadWithRetry:
    ...
    @patch("stockdownloader.data.sec.common.time.sleep")
    ...
    def test_custom_max_retries(self) -> None:
        ...
        with patch("stockdownloader.data.sec.common.time.sleep"):
...
class TestQuarterIterator:
    ...
    @patch("stockdownloader.data.sec.common.date")
...
class TestFetchAllEftsHits:
    ...
    @patch("stockdownloader.data.sec.common.fetch_efts_page")
