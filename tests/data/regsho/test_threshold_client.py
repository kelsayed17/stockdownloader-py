...
from stockdownloader.data.regsho.threshold_client import (
    RegShoThresholdClient,
    ThresholdRecord,
)
from stockdownloader.data.regsho.sources import (
    CBOE_URL_TEMPLATE,
    NASDAQ_URL_TEMPLATE,
    NYSE_URL_TEMPLATE,
    OCC_URL_TEMPLATE,
...
class TestNyseQuery:
    ...
    def test_nyse_parses_symbol_with_market(self, tmp_path: Path) -> None:
        ...
        with patch(
            "stockdownloader.data.regsho.sources.cffi_get",
    ...
    def test_cffi_get_fallback_to_curl(self, tmp_path: Path) -> None:
        ...
        with patch(
            "stockdownloader.data.regsho.sources.curl_get",
