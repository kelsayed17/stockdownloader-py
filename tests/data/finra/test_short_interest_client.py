...
from stockdownloader.data.finra.base_client import normalize_finra_date
...
class TestAuthentication:
    ...
    def test_successful_auth_sets_bearer_token(self, tmp_path: Path) -> None:
        ...
        with patch("stockdownloader.data.finra.base_client.requests.post") as mock_post:
...
class TestAutoAuth:
    ...
    @patch("stockdownloader.data.finra.base_client.requests.post")
