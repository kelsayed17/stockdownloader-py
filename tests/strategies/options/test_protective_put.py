...
from stockdownloader.strategies.options.strategies import OptionsSignal
from stockdownloader.strategies.options.strategies import ProtectivePutStrategy
