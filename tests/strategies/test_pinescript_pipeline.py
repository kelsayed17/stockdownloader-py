...
class TestPipelineWrapperConsistency:
    ...
    def test_sma_wrapper_params_match_python(self):
        ...
        from stockdownloader.app.pinescript_catalog.catalogs import sma_crossover_strategy
    ...
    def test_rsi_wrapper_params(self):
        from stockdownloader.app.pinescript_catalog.catalogs import rsi_strategy
    ...
    def test_macd_wrapper_params(self):
        from stockdownloader.app.pinescript_catalog.catalogs import macd_strategy
    ...
    def test_bollinger_wrapper_no_params(self):
        from stockdownloader.app.pinescript_catalog.catalogs import bollinger_rsi_strategy
        defn = bollinger_rsi_strategy()
        assert defn.short_name == "BB-RSI"

    def test_dmi_vwap_wrapper(self):
        from stockdownloader.app.pinescript_catalog.catalogs import dmi_vwap_strategy
    ...
    def test_breakout_wrapper(self):
        from stockdownloader.app.pinescript_catalog.catalogs import breakout_strategy
    ...
    def test_macd_obv_stays_handwritten(self):
        ...
        from stockdownloader.app.pinescript_catalog.catalogs import macd_obv_strategy
...
class TestIntradayModeRoundTrip:
    ...
    def _mode_to_pine(self, mode: "ModeDefinition") -> str:
        from stockdownloader.pinescript import mode_to_strategy
