...
of :class:`~stockdownloader.data.regsho.threshold_client.ThresholdRecord`
...
:mod:`stockdownloader.data.regsho.threshold_client`.
"""
...
if TYPE_CHECKING:
    from stockdownloader.data.regsho.threshold_client import ThresholdRecord
...
from stockdownloader.data.regsho.nyse import (  # noqa: F401, E402
    nyse_rate_limit,
    save_nyse_progress,
    load_nyse_progress,
