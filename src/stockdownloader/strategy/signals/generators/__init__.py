...
from stockdownloader.strategy.signals.generators.momentum import (
    CCIGenerator,
...
from stockdownloader.strategy.signals.generators.trend import (
    ADXTrendGenerator,
    EMATrendGenerator,
    IchimokuGenerator,
    SARGenerator,
...
from stockdownloader.strategy.signals.generators.volatility import (
    BBSqueezeGenerator,
    BBTouchGenerator,
)
from stockdownloader.strategy.signals.generators.volume import (
    MFIGenerator,
    OBVGenerator,
