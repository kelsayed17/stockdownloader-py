"""Multi-timeframe ML pipeline for SPY.

Runs the 6-stage ML pipeline on daily data and intraday timeframes
(15m, 30m, 1h, 4h) resampled from 5-minute bars.  Includes optional
HMM regime detection as additional ML features.
